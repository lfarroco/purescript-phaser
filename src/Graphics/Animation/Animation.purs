...
import Graphics.Phaser.Animation.Types (Animation, AnimationFrame, AnimationManager, AnimationState, AnimationsNamespace, JSONAnimation, TextureManager)
import Utils.FFI (_getProp, _method0, _method1, _method2, _new3, _return0, _return1, _return2, phaser)

animationsNamsepace :: Effect AnimationsNamespace
animationsNamsepace = phaser >>= _getProp "Animations"
...
new mngr key' animation = do
  fn <- animationsNamsepace >>= _getProp "Animation"
