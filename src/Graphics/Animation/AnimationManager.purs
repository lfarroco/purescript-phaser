...
import Graphics.Phaser.Animation.Types (GenerateFrameNumbersConfig, Animation, AnimationManager, JSONAnimation, TextureManager)
...
new game' = do
  fn <- animationsNamsepace >>= _getProp "AnimationManager" 
  _new1 fn game'
