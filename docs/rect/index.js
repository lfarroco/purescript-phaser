...
(function($PS) {
  ...
  var graphicsInstance = new GameObject(function (i) {
  ...
  exports["graphicsInstance"] = graphicsInstance;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var Data_Function_Uncurried = $PS["Data.Function.Uncurried"];                
  var solidRect = Data_Function_Uncurried.runFn4($foreign.solidRectImpl);
  exports["solidRect"] = solidRect;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.3
  "use strict";
  ...
  var create = function (scene) {
      return function (_state) {
          return function __do() {
              var rect = Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_Graphics.solidRect({
                  x: 100.0,
                  y: 100.0
              })({
                  width: 100.0,
                  height: 100.0
              })("#000")(scene))(Graphics_Phaser_GameObject.setAlpha(Graphics_Phaser_GameObject.graphicsInstance)(0.3))();
