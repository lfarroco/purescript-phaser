...
(function($PS) {
  ...
  var setAngle = function (dictGameObject) {
...
(function($PS) {
  ...
  var mainScene = (function () {
      var startButton = function (scene) {
          var callback = Data_Functor["void"](Effect.functorEffect)(Graphics_Phaser_Scene.launch("snd")({})(scene));
          var listener = Graphics_Phaser_Events.createEventListener0(callback);
          return Data_Functor["void"](Effect.functorEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_Image.create("logo")(scene))(Graphics_Phaser_GameObject.setPosition()({
              x: 100.0,
              y: 100.0
          })))(Graphics_Phaser_GameObject.setDisplaySize()({
              width: 50.0,
              height: 50.0
          })))(Graphics_Phaser_Events.onListener()("pointerdown")(listener)));
      };
      return {
