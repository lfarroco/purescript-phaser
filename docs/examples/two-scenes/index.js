...
(function($PS) {
  ...
  var secondScene = (function () {
      var createLogo = Control_Bind.composeKleisli(Effect.bindEffect)(Graphics_Phaser_Image.create("logo"))(Control_Bind.composeKleisli(Effect.bindEffect)(Graphics_Phaser_GameObject.setPosition(Graphics_Phaser_GameObject.imageInstance)({
          x: 200.0,
          y: 200.0
  ...
  var main = Data_Functor["void"](Effect.functorEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser.create)(Graphics_Phaser.setGameDimensions({
      width: 400.0,
      height: 400.0
  })))(Graphics_Phaser_Scene.addScene(mainScene)))(Graphics_Phaser_Scene.addScene(secondScene)));
  exports["main"] = main;
