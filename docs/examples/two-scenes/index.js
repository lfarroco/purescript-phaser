...
(function($PS) {
  ...
  var setAngle = function (dictTransform) {
      return Utils_FFI.method1("setAngle(v1)");
  };
...
(function($PS) {
  ...
  var Utils_FFI = $PS["Utils.FFI"];                  
  var launch = Utils_FFI.method2("launch(v1,v2)"); 
  var getScenePlugin = function (dictHasScenePlugin) {
      return Utils_FFI.getProperty("scene");
  };
  exports["getScenePlugin"] = getScenePlugin;
...
(function($PS) {
  ...
  var mainScene = (function () {
      var startButton = function (scene) {
          var callback = Data_Functor["void"](Effect.functorEffect)(function __do() {
              Effect_Class_Console.log(Effect_Class.monadEffectEffect)("clicked!")();
              return Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_Scene.getScenePlugin()(scene))(Graphics_Phaser_Scene.launch("snd")({}))();
          });
          var listener = Graphics_Phaser_Events.createEventListener0(callback);
          return Data_Functor["void"](Effect.functorEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_Image.create("logo")(scene))(Graphics_Phaser_GameObject.setPosition()({
              x: 100.0,
              y: 100.0
          })))(Graphics_Phaser_GameObject.setDisplaySize()({
              width: 50.0,
              height: 50.0
          })))(Graphics_Phaser_GameObject.setInteractive()))(Graphics_Phaser_Events.on()("pointerdown")(listener)));
      };
      return {
  ...
  var secondScene = (function () {
      var createLogo = Control_Bind.composeKleisli(Effect.bindEffect)(Graphics_Phaser_Image.create("logo"))(Control_Bind.composeKleisli(Effect.bindEffect)(Graphics_Phaser_GameObject.setPosition()({
          x: 200.0,
          y: 200.0
      }))(Control_Bind.composeKleisli(Effect.bindEffect)(Graphics_Phaser_GameObject.setAngle()(30.0))(Graphics_Phaser_GameObject.setDisplaySize()({
          width: 50.0,
          height: 50.0
      }))));
      return {
  ...
  var main = function __do() {
      ...
      Data_Functor["void"](Effect.functorEffect)(Graphics_Phaser_SceneManager.addScene(Option.fromRecordAny(Option.fromRecordOptionCons({
          reflectSymbol: function () {
              return "create";
          }
      })(Option.fromRecordOptionCons({
      ...
      return Data_Functor["void"](Effect.functorEffect)(Graphics_Phaser_SceneManager.addScene(Option.fromRecordAny(Option.fromRecordOptionCons({
          reflectSymbol: function () {
              return "create";
          }
      })(Option.fromRecordOptionCons({
      ...
      })(Option.fromRecordOptionNil)()()())()()())(Option.fromRecordRequiredNil)()()())("snd")(secondScene)(Graphics_Phaser_SceneManager.NoStart.value)(game))();
  };
  exports["main"] = main;
