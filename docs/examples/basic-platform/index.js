...
(function($PS) {
  ...
  var createStaticGroup = Utils_FFI.return0("add.staticGroup()");
  var createChild = function (dictArcadeGroup) {
      return Utils_FFI.return2("create(v1.x,v1.y,v2)");
  };
  var createArcadeSprite = Utils_FFI.return2("add.sprite(v1.x,v1.y,v2)");
  var createArcadeImage = Utils_FFI.return2("add.image(v1.x,v1.y,v2)");
      ...
      return function (dictCollidable1) {
          return function (dictCollidable2) {
              return function (dictCollidable3) {
                  return Utils_FFI.method3("add.overlap(v1,v2,(a,b)=>v3(a)(b)())");
              };
          };
      };
  };
  var addCollider = function (dictCollidable) {
      return function (dictCollidable1) {
          return Utils_FFI.method2("add.collider(v1,v2)");
      };
  };
...
(function($PS) {
      ...
      return function (dictSprite) {
          return function (cursors) {
              return function (sprite) {
                  var stop = Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_ArcadePhysics.setVelocityX()(0.0)(sprite))(Graphics_Phaser_Sprite.playAnimation()({
                      key: "turn",
                      ignoreIfPlaying: false
                  }));
                  var moveRight = Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_ArcadePhysics.setVelocityX()(150.0)(sprite))(Graphics_Phaser_Sprite.playAnimation()({
                      key: "right",
                      ignoreIfPlaying: true
                  }));
                  var moveLeft = Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_ArcadePhysics.setVelocityX()(-150.0)(sprite))(Graphics_Phaser_Sprite.playAnimation()({
                      key: "left",
                      ignoreIfPlaying: true
                  }));
                  return Data_Functor["void"](Effect.functorEffect)(function __do() {
                      var isRight = Graphics_Phaser_Input.isDown(cursors.right)();
                      var isLeft = Graphics_Phaser_Input.isDown(cursors.left)();
                      if (isRight) {
                          return moveRight();
                      };
                      if (isLeft) {
  ...
  var update = function (cursors) {
      return function (scene) {
          var movePlayer = (function () {
              var jump = Graphics_Phaser_ArcadePhysics.setVelocityY()(-350.0);
              return function __do() {
                  ...
                  if (player instanceof Data_Maybe.Just) {
                      return Data_Functor["void"](Effect.functorEffect)(function __do() {
                          ...
                          var isUp = Graphics_Phaser_Input.isDown(cursors.up)();
                          move()()(cursors)(player.value0)();
                          var $5 = isUp && touching.down;
                          if ($5) {
                  ...
                  throw new Error("Failed pattern match at Main (line 130, column 5 - line 140, column 41): " + [ player.constructor.name ]);
              };
          })();
          var movePlatform = function __do() {
              ...
              throw new Error("Failed pattern match at Main (line 146, column 5 - line 157, column 49): " + [ platform.constructor.name ]);
          };
          return Data_Functor["void"](Effect.functorEffect)(function __do() {
              movePlayer();
              return movePlatform();
  ...
  var create = function (scene) {
          ...
          return function (stars) {
              return function (platformsGroup) {
                  return function (movingPlatform) {
                      return Control_Bind.composeKleisli(Effect.bindEffect)(Graphics_Phaser_ArcadePhysics.addCollider()()(player)(platformsGroup))(Control_Bind.composeKleisli(Effect.bindEffect)(Graphics_Phaser_ArcadePhysics.addCollider()()(player)(movingPlatform))(Control_Bind.composeKleisli(Effect.bindEffect)(Graphics_Phaser_ArcadePhysics.addCollider()()(stars)(movingPlatform))(Control_Bind.composeKleisli(Effect.bindEffect)(Graphics_Phaser_ArcadePhysics.addCollider()()(stars)(platformsGroup))(Graphics_Phaser_ArcadePhysics.addOverlap()()()()(player)(stars)(collectStar)))));
                  };
              };
          };
      };
      var createStars = function (phy) {
          return function __do() {
              var starsEff = Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Functor.map(Data_Functor.functorArray)(function (n) {
                  return Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_ArcadePhysics.createArcadeImage({
                      x: 50.0 + Data_Int.toNumber(n) * 40.0,
                      y: 100.0
                  })("star")(phy))(Graphics_Phaser_ArcadePhysics.setBounce()(0.4)))(Graphics_Phaser_ArcadePhysics.setCollideWorldBounds()(true));
              })(Data_Array.range(1)(15)))();
              return starsEff;
          };
      };
      var createPlayer = function (phy) {
          return Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_ArcadePhysics.createArcadeSprite({
              x: 50.0,
              y: 500.0
          })("dude")(phy))(Graphics_Phaser_ArcadePhysics.setBounce()(0.4)))(Graphics_Phaser_ArcadePhysics.setCollideWorldBounds()(true)))(Graphics_Phaser_GameObject.setName()("player"));
      };
      var createPlatform = function (phy) {
          return Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_ArcadePhysics.createArcadeImage({
              x: 400.0,
              y: 400.0
          })("platform")(phy))(Graphics_Phaser_ArcadePhysics.setImmovable()(true)))(Graphics_Phaser_ArcadePhysics.setAllowGravity()(false)))(Graphics_Phaser_ArcadePhysics.setVelocityX()(50.0)))(Graphics_Phaser_GameObject.setName()("moving_platform"));
      };
      var createFloor = function (group) {
          return Data_Functor["void"](Effect.functorEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_ArcadePhysics.createChild()({
              x: 400.0,
              y: 568.0
      ...
      var createBg = Data_Functor["void"](Effect.functorEffect)(Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_Image.create("sky")(scene))(Graphics_Phaser_GameObject.setPosition()({
          x: 400.0,
          y: 300.0
      })));
      var createAnimations = function __do() {
      ...
      return Data_Functor["void"](Effect.functorEffect)(function __do() {
          var phy = Graphics_Phaser_Scene.getPhysicsPlugin(scene)();
          createBg();
          var platformsGroup = Graphics_Phaser_ArcadePhysics.createStaticGroup(phy)();
          ...
          Data_Functor["void"](Effect.functorEffect)(createAnimations)();
          Data_Functor["void"](Effect.functorEffect)(setupCollisions(player)(stars)(platformsGroup)(movingPlatform)(phy))();
          return Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_Events.getEventEmitter()(scene))(Graphics_Phaser_Events.on()("update")(Graphics_Phaser_Events.createEventListener0(update(cursors)(scene))))();
      });
  };
