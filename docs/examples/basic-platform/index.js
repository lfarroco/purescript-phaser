...
(function($PS) {
  ...
  var create = function (scene) {
      ...
      var createPlayer = Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_ArcadePhysics.createArcadeSprite({
          x: 50.0,
          y: 500.0
      ...
      var createPlatform = Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_ArcadePhysics.createArcadeImage({
          x: 400.0,
          y: 400.0
      ...
      var createAnimations = function __do() {
          ...
          Data_Functor["void"](Effect.functorEffect)(Graphics_Phaser_Sprite.createAnimation("right")(rightWalkFrames)(10.0)(-1 | 0)(scene))();
          return scene;
      };
      return Data_Functor["void"](Effect.functorEffect)(function __do() {
          createBg();
          var platformsGroup = Graphics_Phaser_ArcadePhysics.createStaticGroup(scene)();
          createFloor(platformsGroup)();
          var movingPlatform = createPlatform();
          var player = createPlayer();
          var stars = createStars();
          var cursors = Graphics_Phaser_Input.createCursorKeys(scene)();
          return Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(createAnimations)(setupCollisions(player)(stars)(platformsGroup)(movingPlatform)))(Graphics_Phaser_Events.getEventEmitter()))(Graphics_Phaser_Events.on()("update")(Graphics_Phaser_Events.createEventListener0(update(cursors)(scene))))();
      });
  };
