...
(function($PS) {
  ...
  var return0 = function (expr) {
      return function (obj) {
          return Data_Foreign_EasyFFI.unsafeForeignFunction([ "obj", "" ])("obj." + expr)(obj);
      };
  };
...
(function($PS) {
  ...
  var onListener = function (dictEventEmitter) {
...
(function($PS) {
  ...
  var Utils_FFI = $PS["Utils.FFI"];
  var setPosition = function (dictGameObject) {
  ...
  var mainScene = (function () {
      ...
      var startButton = function (scene) {
                  ...
                  return function (localY) {
                      return function __do() {
                          ...
                          (function () {
                              ...
                              throw new Error("Failed pattern match at Main (line 64, column 7 - line 66, column 55): " + [ clickable.constructor.name ]);
                          })();
          ...
          return Data_Functor["void"](Effect.functorEffect)(function __do() {
              ...
              return Graphics_Phaser_Events.onListener()("pointerdown")(listener)(image)();
          });
      };
      return {
