...
(function($PS) {
  ...
  var on = function (dictEventEmitter) {
      return Data_Foreign_EasyFFI.unsafeForeignProcedure([ "key", "listener", "obj", "" ])("console.log(key, listener, obj); obj.on(key, listener); return obj;");
  };
  exports["on"] = on;
})(PS);
(function($PS) {
...
(function($PS) {
  ...
  var mainScene = (function () {
      var startButton = function (scene) {
          ...
          return function __do() {
              var image = Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Graphics_Phaser_Image.create("logo")(scene))(Graphics_Phaser_GameObject.setPosition()({
                  x: 100.0,
                  y: 100.0
              })))(Graphics_Phaser_GameObject.setDisplaySize()({
                  width: 50.0,
                  height: 50.0
              })))(Graphics_Phaser_GameObject.setInteractive())();
              Graphics_Phaser_Events.on()("pointerdown")(callback)(image)();
              return scene;
          };
      };
      return {
