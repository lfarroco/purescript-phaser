...
(function($PS) {
  ...
  var $foreign = $PS["Graphics.Phaser.Events"];
  var createSceneListener = function (key) {
      return function (fn) {
          return function (scene) {
              return function __do() {
                  $foreign.createSceneListener_(key)(fn)(scene)();
                  return function (arg) {
                      return $foreign.emitSceneEvent(key)(arg)(scene);
                  };
              };
          };
      };
  ...
  var createListener = function (key) {
      return function (fn) {
          return function (emitter) {
              return function __do() {
                  $foreign.on(key)(fn)(emitter)();
                  return function (arg_) {
                      return $foreign.emit(key)(arg_)(emitter);
                  };
              };
          };
      };
  ...
  exports["createSceneListener"] = createSceneListener;
  exports["createEmitter"] = $foreign.createEmitter;
  exports["destroyEmitter"] = $foreign.destroyEmitter;
})(PS);
(function(exports) {
  'use strict';
  ...
  var testScene1 = function (sceneManager) {
      return Graphics_Phaser_Scene.addScene("testScene")({
          ...
          create: function (scene) {
              return function (data_) {
                  return function __do() {
                      var emitter = Graphics_Phaser_Events.createEmitter(Data_Unit.unit)();
                      var speak = Graphics_Phaser_Events.createListener("speak_event")(function (n) {
                          return Effect_Class_Console.log(Effect_Class.monadEffectEffect)(">>>" + Data_Show.show(Data_Show.showInt)(n));
                      })(emitter)();
                      ...
                      speak(222)();
                      speak(333)();
                      Graphics_Phaser_Events.destroyEmitter(emitter)();
                      speak(444)();
                      var yell = Graphics_Phaser_Events.createSceneListener("yell")(function (n) {
                          return Effect_Class_Console.log(Effect_Class.monadEffectEffect)(n);
                      })(scene)();
                      return yell("AAA")();
                  };
              };
